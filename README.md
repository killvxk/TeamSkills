...
基于 Claude Code Agent Team 能力的团队管理技能包。通过 7 个 slash command 实现团队的全生命周期管理：创建、保存、加载、查看、监控和终止。内置 51 个核心角色 + 146 个扩展专业角色，覆盖 8 种团队类型和 12 个扩展领域。
